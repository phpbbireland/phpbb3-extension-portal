...
class portal
{
	...
	*/
	...
	{
		/*  NV
		    Originally the code to build the portal was placed here but in an effort to
		    make is assessable when the index page (and all the other pages as blocks can displayed on any page) 
		    I have moved it to the main controller...

		    Now the question....
		    The main controller calls this function "main" but for the index I rely on injecting the blocks using the
		    events... but how an I get the main_listener.php to access a function in the main controller?
